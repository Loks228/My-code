    ...
    buttonEng.addEventListener('mouseup', function() {
      ...
      function checkInputName() {
        ...
        if (inputField.value == '') {
            ...
            statusIcon.innerHTML = '<img src="/static/Logo-site/крестик в кружке.jpg" width="15px" />';
        } else {
            // Поле заполнено, показываем галочку
            statusIcon.innerHTML = '<img src="/static/Logo-site/галочка в кружке.png" width="15px" />';
        }
    }
